...
<head>
    ...
    <link href="assets/css/components/hardware-hub.css" rel="stylesheet">
        ...
        <div class="startup-container">
            <div class="startup-terminal" data-aos="fade-up">
                ...
                <div class="terminal-body">
                    <div class="terminal-line">
                        <span class="prompt">$</span>
                        <span class="command"> ./startup-info.sh </span>
                    </div>
                    <div class="terminal-line output">
                        <span class="text-primary">Company : </span>Hardware Hub
                    </div>
                    <div class="terminal-line output">
                        <span class="text-primary"> Role : </span>Co-Founder & CTO
                    </div>
                    <div class="terminal-line output">
                        <span class="text-primary"> Product : </span>Hardware Hub website
                    </div>
                    <div class="terminal-line output">
                        <span class="text-primary"> Status : </span><span class="status-active"> Active Development </span>
                    </div>
                    <div class="terminal-line">
                        <span class="prompt">$</span>
                        <span class="cursor-blink">_</span>
            ...
            <div class="startup-content" data-aos="fade-left">
                <div class="startup-card">
                    <div class="card-header">
                        ...
                        <span class="badge-startup"> Company </span>
                    </div>

                    <div class="startup-description">
                        <p> We're revolutionizing PC building with our innovative tool that helps users design their perfect setup at the best available prices. </p>
                        <p> Config-Maker only features components validated by our expertise and backed by reliable sources, ensuring quality and compatibility. </p>
                    </div>
                    ...
                    <div class="features-grid">
                        <div class="feature-item">
                            ...
                            <h4> Beginner Mode </h4>
                            <p> Simplified experience to quickly create a quality configuration </p>
                        </div>
                        <div class="feature-item">
                            <i class="mdi mdi-shield-check"></i>
                            <h4> Validated Expertise </h4>
                            <p> Components rigorously tested and approved by our experts </p>
                        </div>
                        <div class="feature-item">
                    ...
                    <div class="startup-links">
                        <a href="https://hardware-hub.fr" target="_blank" class="startup-link primary">
                            <i class="mdi mdi-web"></i>
                            <span> Website </span>
                            <i class="mdi mdi-arrow-right"></i>
                        </a>
                        <a href="" target="_blank" class="startup-link secondary">
