...
<html lang="fr">
    ...
    <body>
            ...
            <div class="container">
                <div class="filters-wrapper" data-aos="fade-up">
                    <div class="filter-group">
                        <button class="filter-btn" data-filter="all" onclick="switch_page('')">
                            <i class="mdi mdi-view-grid"></i>
                            <span> All Writeups </span>
                        </button>
                        <button class="filter-btn active" data-filter="hackthebox" onclick="switch_page('hackthebox')">
        ...
        <section class="writeups-content section">
            <div class="container">
                <div class="writeups-grid">
                        ...
                        <?php foreach ($wt as $name => $writeup): ?>
        ...
        <?php require_once 'views/components/footer.part.php'; ?>
