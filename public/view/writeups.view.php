...
<html lang="fr">
    <head>
        ...
        <link href="public/css/components/writeups.css" rel="stylesheet">
    ...
    <body>
        <header class="header" id="header">
            <nav class="nav container">
                <a href="/" class="nav-logo">
                    <img src="public/img/icon.jpg" alt="Dawnl3ss logo">
                </a>
        ...
        <section class="writeups-content section">
            <div class="container">
                <div class="writeups-grid">
                    ...
                    <?php foreach ($writeups as $platform => $wts): ?>
            ...
            <div class="container">
                <div class="stats-grid" data-aos="fade-up">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?= $realWuCount; ?></div>
                        <div class="stat-label"> Total Writeups </div>
                    </div>
                    <div class="stat-card">
                        <i class="mdi mdi-cube-outline"></i>
                        <div class="stat-value"> <?= count($writeups["hackthebox"]); ?> </div>
                        <div class="stat-label"> HTB Machines </div>
                    </div>
                    <div class="stat-card">
                        <i class="mdi mdi-shield-outline"></i>
                        <div class="stat-value"> <?= count($writeups["tryhackme"]); ?> </div>
        ...
        <script src="public/js/writeups.js"></script>
